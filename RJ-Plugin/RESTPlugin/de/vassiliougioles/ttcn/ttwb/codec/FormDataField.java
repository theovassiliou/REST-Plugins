...
public class FormDataField implements Value, TTCNRESTMapping {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4439124664042666893L;
	Value v = null;
	String fn = "";

	public FormDataField(Value value, String fieldName) {
		v = value;
		fn = fieldName;
		return;
	}
	...
	static public List<FormDataField> collectParams(Value theValue, String fieldName) {
		List<FormDataField> listOfValue = new ArrayList<FormDataField>();
...
//			if (theValue.getValueEncoding().startsWith(_PATH_FORMDATA_FIELD_ENCODING_PREFIX_)) {
//				listOfValue.add(new FormDataField(theValue, fieldName));
//			}
			break;
		default:
			break;
	...
	static public String buildQueryParams(List<FormDataField> params) {
		StringBuilder sb = new StringBuilder();
		boolean hasParam = false; 
		for (FormDataField value : params) {
	...
	public boolean isParameter() {
		return true;
//		return !v.notPresent() && (v.getValueEncoding().startsWith(_PATH_FORMDATA_FIELD_ENCODING_PREFIX_));
