 ...
 *
 */
public class PATCHMessage extends RESTMessage {

	public PATCHMessage(Value sendMessage, TriAddress triAddress, Value portConfiguration) throws Exception {
		super(sendMessage, triAddress, portConfiguration);
		request = newRequest(endpoint);
		request.method("PATCH");
		defaultRequest(request);
		
		// PATCH can have a body. But in case it has one, appended.
